...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-5">
                       ...
                       <div class="modal-content">
                           <form method="POST" action="{{ route('mypage.destroy') }}">
                               ...
                               <div class="modal-header">
                                   <h5 class="modal-title" id="staticBackdropLabel">本当に退会しますか？</h5>
            ...
            <button type="button" class="btn nagoyameshi-delete-submit-button dashboard-delete-link mt-3 w-25" data-bs-toggle="modal" data-bs-target="#delete-user-confirm-modal">
                退会する
            </button>
